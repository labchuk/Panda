...
<script setup>
import CardWeather from '@/components/CardComponent.vue'
import { setItem, getItem } from '@/helpers/localStorage.js'
import { uuid } from 'vue-uuid'
import { getIp } from '@/api/getIp'
import { ref, onMounted, computed } from 'vue'
import ModalWeather from '@/components/ModalComponent.vue'
